...
var books = ["Dog days of Summer", "teeth", "His new shoe", "My cat, Raja", "To the end of time"];
console.log(books);
...
var belowTwoHundred = [12, 16, 27, 28, 29, 57, 59, 62, 65, 68, 79, 102];
